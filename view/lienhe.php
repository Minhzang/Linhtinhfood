        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-4">
            <div class="grid gap-12 sm:grid-cols-2 lg:col-span-2">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 ">Đội ngũ thân thiện của chúng tôi sẵn sàng trợ giúp.</p>
                ...
                <div>
                    ...
                    <h2 class="mt-4 text-base font-medium text-gray-800 ">Cửa hàng</h2>
                    <p class="mt-2 text-sm text-gray-500 ">Hãy đến chào cửa hàng của chúng tôi..</p>
                    <p class="mt-2 text-sm text-blue-500 ">HCM: Lầu 6, 182 Lê Đại Hành, P.15, Quận 11, Tp.HCM</p>
                </div>
                ...
                <div>
                    ...
                    <h2 class="mt-4 text-base font-medium text-gray-800 ">Điện thoại</h2>
                    <p class="mt-2 text-sm text-gray-500 ">Thứ Hai-Thứ Sáu từ 8 giờ sáng đến 5 giờ chiều.</p>
                    <p class="mt-2 text-sm text-blue-500 ">1900.636.099</p>
                </div>
            </div>
